...
**attributes**
```
'Civilian', 'UseTeamColor', 'DoesNotHideChest', 'DropOnWeaponChange', 'ForceAttachOffHandPrimaryItemBone', 'HeldInOffHand',
 'HasToBeHeldUp', 'WoodenParry', 'DoNotScaleBodyAccordingToWeaponLength', 'QuickFadeOut', 'CannotBePickedUp', 'DropOnAnyAction', 
